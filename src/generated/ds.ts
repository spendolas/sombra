...
export const ds = {
  ...
  fileDropDialog: {
    ...
    panel: "flex flex-row bg-surface-raised rounded-md p-lg gap-lg overflow-hidden",
    preview: "flex flex-row bg-surface rounded-sm overflow-hidden",
  ...
  colorPicker: {
    ...
    formTrigger: "rounded-sm text-handle text-fg-dim cursor-pointer hover:bg-surface-elevated hover:text-fg inline-flex items-center gap-1 px-2 py-1",
    ...
    channelLabel: "text-handle text-fg",
