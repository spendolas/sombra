...
const artifact: SceneArtifact = {
  ...
  manifest: [{
    key: 'noise-scale', uniform: 'u_a_scale', nodeId: 'a', node: 'Noise', nodeType: 'noise',
    param: 'scale', label: 'Scale', type: 'float', glslType: 'float', min: 0, max: 1, step: 0.01, default: 0.5,
  }],
